...
import os
import sys
this_folder = '/user02/models'
cwd = os.getcwd()
sys.path.append(cwd.replace(this_folder, ''))
from utils import log_best_xgb


# LightGBM GBDT with KFold or Stratified KFold
def kfold_xgb(train_df, test_df, target_col, model_loss, num_folds, feats_exclude, stratified=False, use_gpu=False):
